            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <Link
                    to="/solutions/b2c"
                    className="p-4 rounded-lg bg-gradient-to-br from-white to-green-50 shadow hover:shadow-md transition"
                  >
              ...
              >
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2F59bf3e928fc9473a97d5e87470c824bb%2F7267956a86a942cab07f1709dec9e830?format=webp&width=800"
                  alt="Solar overview"
