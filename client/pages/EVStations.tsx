...
export default function EVStations() {
  ...
  const highlights = [
    { icon: Zap, title: "EV Charge Infrastructure", desc: "Design and deployment of charging infrastructure for commercial, fleet and public spaces." },
    { icon: Car, title: "EV Charging Solutions", desc: "AC and DC fast charging deployments, smart charging and payment integrations." },
    { icon: Truck, title: "Fleet & Depot Charging", desc: "Turnkey solutions for bus, truck and commercial fleet electrification." },
  ];
      ...
      <main className="pt-16">
        <section ref={heroRef} className="py-24 bg-gradient-to-br from-background via-green-50 to-accent">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-8 flex justify-center gap-4">
              <Link to="/solutions/ev-stations#infrastructure" className="inline-block px-5 py-3 rounded-full bg-primary text-primary-foreground">EV Charge Infrastructure</Link>
              <Link to="/solutions/ev-stations#charging" className="inline-block px-5 py-3 rounded-full bg-white border">EV Charging</Link>
            </div>
          </div>
        </section>
        ...
        <section ref={listRef} className="py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-semibold mb-6">EV Stations Offerings</h2>
            ...
            <div className="mt-12 bg-gradient-to-r from-primary to-green-600 rounded-2xl p-8 text-white">
              <motion.h3 initial={{ opacity: 0, x: -20 }} animate={isListInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -20 }} transition={{ duration: 0.6 }} className="text-xl font-bold mb-3">Deploy EV charging at scale</motion.h3>
              <p className="opacity-90">We offer planning, permitting, supply and operations for charging networks and depot electrification.</p>
            </div>
          </div>
        </section>
      </main>
